...
----- Administrators
(10021,	'myapp-backend',		    'Administrator',			 'adminList',		      			'Admin Home page',								        0,				'^/sec/admins$',									              				'...',															                                                    0,0,current_timestamp,current_timestamp),
(10022,	'myapp-backend',		    'Administrator',			 'adminAdd',		      			'Admin register page',								    1,				'^/sec/admins/add$',									              		    '...',															                                                    0,0,current_timestamp,current_timestamp),
(10023,	'myapp-backend',		    'Administrator',			 'adminEdit',		      			'Admin edit page',								        1,				'^/sec/admins/[0-9]{1,}/edit$',									                '...',															                                                    0,0,current_timestamp,current_timestamp),
(10024,	'myapp-backend',		    'Administrator',			 'adminRemove',		      			'To remove existing administrator',						1,				'^/sec/admins/[0-9]{1,}/delete$',									            '...',															                                                    0,0,current_timestamp,current_timestamp),
(10025,	'myapp-backend',		    'Administrator',			 'adminDetail',		      			'View detail information of an administrator',			1,				'^/sec/admins/[0-9]{1,}$',									                    '...',															                                                    0,0,current_timestamp,current_timestamp),
----- Users
(10031,	'myapp-backend',		    'User',			 	         'userList',		      			'User Home page',								        0,				'^/sec/users$',									              				    '...',															                                                    0,0,current_timestamp,current_timestamp),
(10032,	'myapp-backend',		    'User',			 	         'userAdd',		      			    'User register page',								    1,				'^/sec/users/add$',									              		        '...',															                                                    0,0,current_timestamp,current_timestamp),
(10033,	'myapp-backend',		    'User',			 	         'userEdit',		      			'User edit page',								        1,				'^/sec/users/[0-9]{1,}/edit$',									                '...',															                                                    0,0,current_timestamp,current_timestamp),
(10034,	'myapp-backend',		    'User',			 	         'userRemove',		      			'To remove existing user',								1,				'^/sec/users/[0-9]{1,}/delete$',									            '...',															                                                    0,0,current_timestamp,current_timestamp),
(10035,	'myapp-backend',		    'User',			 	         'userDetail',		      			'View detail information of a user',					1,				'^/sec/users/[0-9]{1,}$',									                    '...',															                                                    0,0,current_timestamp,current_timestamp);
